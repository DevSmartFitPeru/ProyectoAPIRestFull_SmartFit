...
def location():
    try:
        cursor = connect(aws_access_key_id="AKIA4LTBLLTULQVURH6J", aws_secret_access_key="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", s3_staging_dir="s3://7-smartfit-da-de-lake-artifacts-athena-latam/", region_name="us-east-1", work_group="peru", schema_name="prod_lake_modeled_refined").cursor()
