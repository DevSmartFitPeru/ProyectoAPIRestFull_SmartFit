...
def payment_ar(fecha_inicio,fecha_fin):
    try:
        ...
        for row in records:
            ...
            cur = connposgresql.cursor()
            query_sql_insert = 'insert into "PAYMENT"."payment"(front_id, fecha_pago, sigla_unidad, nombre_ubicacion, matricula_usuario, importe, tipo_pago, Plan, metodo_pago, descripcion_mensualidad, financiero, authorization_number, card_number, minifactu_id, invoice_code, fin_id)' \
                              " values(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s,%s,%s,%s,%s,%s,%s) "
            cur.execute(query_sql_insert,(front_id, fecha_pago, sigla_unidad, nombre_ubicacion, matricula_usuario, importe, tipo_pago, Plan, metodo_pago, descripcion_mensualidad, financiero, authorization_number, card_number, minifactu_id, invoice_code, fin_id))
        connposgresql.commit()
